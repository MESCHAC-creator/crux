class MeetingModel {
  ...
  final bool isLargeConference; // true → Jitsi SFU (100+ people)
...
/// Simple 6-digit meeting code for easy joining.
/// Generated from meetingId hash or stored separately.
class MeetingCode {
  final String code;      // e.g. "123456"
  final String meetingId; // e.g. "A1B2C3D4E5F6"
  final DateTime createdAt;
  ...
  factory MeetingCode.fromJson(Map<String, dynamic> json) => MeetingCode(
    code: json['code'] ?? '',
